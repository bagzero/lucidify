                    ...
                    <div className="flex flex-col justify-between">
                        <div className="flex items-center mb-[50px]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <h3 className="TextFont mt-[10px] sm:max-w-auto max-w-[250px]">We get your vision and map out the plan. </h3>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center my-[50px]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="w-[75px] h-[1px] bg-gradient-to-br from-[#6265F0] to-[#383A8A]"></div>
                                <h3 className="TextFont mt-[10px] sm:max-w-auto max-w-[250px]">We design a stunning site that fits your brand. </h3>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center my-[50px]">
                            ...
                            <div className="flex flex-col max-w-[400px]">
                                ...
                                <div className="w-[75px] h-[1px] bg-gradient-to-br from-[#6265F0] to-[#383A8A]"></div>
                                <h3 className="TextFont mt-[10px] sm:max-w-auto max-w-[250px]">We build your site with precision, ensuring speed, functionality, and responsiveness. </h3>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center mt-[50px]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="w-[75px] h-[1px] bg-gradient-to-br from-[#6265F0] to-[#383A8A]"></div>
                                <h3 className="TextFont mt-[10px] sm:max-w-auto max-w-[250px]">We launch your website for free. It’s that simple.</h3>
                            </div>
                        </div>
                    </div>
                </div>
