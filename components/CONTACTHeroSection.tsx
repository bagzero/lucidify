    ...
    return (
        <section>
            <div className="flex justify-center rounded-[50px] mx-auto BackgroundGradient pb-[100px] pt-[75px]">
                <div className="flex items-start w-full flex-col mt-[125px] sm:mb-[150px] mb-[125px] 2xl:mt-[125px] 2xl:mb-[150px] xl:mt-[80px] xl:mb-[125px] lg:mt-[70px] lg:mb-[100px] max-w-[650px] mr-[75px]">
