                                ...
                                <div className="flex flex-col w-[1037px] items-start gap-[13px]">
                                    ...
                                    <div className="flex items-center gap-[30px] w-full">
                                        <button
                                            ...
                                            className={`inline-flex items-center justify-center px-[15px] py-[8.5px] rounded-[5px] ${formData.maintenancePlan === 'Yes' ? 'PopupAttentionGradient' : 'BlackGradient'
                                                } ContentCardShadow text-xs`}
                                        >
                                            Yes
                                        </button>
                                        <button
                                            ...
                                            className={`inline-flex items-center justify-center px-[15px] py-[8.5px] rounded-[5px] ${formData.maintenancePlan === 'No' ? 'PopupAttentionGradient' : 'BlackGradient'
                                                } ContentCardShadow text-xs`}
                                        >
                                            No
                                        </button>
