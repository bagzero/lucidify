    ...
    return (
        <section className="items-center">
            ...
            <div className="items-center">
                <div className="flex sm:flex-row flex-col justify-between mx-auto max-w-[1620px] 2xl:max-w-[1620px] xl:max-w-[90%]">
                    <div className="flex flex-col sm:mr-[150px] 2xl:mr-[150px] xl:mr-[100px] sm:max-w-[100%] max-w-[85%] sm:mx-none mx-auto">
                        <Link
                    ...
                    <div className="flex flex-col justify-center align-center sm:mt-[300px] mt-[75px] sm:max-w-[100%] max-w-[85%] sm:mx-none mx-auto">
                        <Link
                            className="flex justify-center items-center TransparentBackgroundGradient rounded-[50px] CaseStudyHover"
