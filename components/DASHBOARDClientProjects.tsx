                                        ...
                                        >
                                            ...
                                            {project.approval === "Approved" && (
                                                <Link
                                                    ...
                                                    className="ClientProjectHover flex absolute z-10 gap-[25px] w-full h-full justify-center items-center hover:bg-black hover:bg-opacity-60">
                                                    <div
                                                        className="ClientProject opacity-0 hover:scale-95 rounded-full BlackWithLightGradient ContentCardShadow flex justify-center items-center gap-[8px]">
                                                        <h3 className="pl-[18px] text-[15px] font-light">View More</h3>
