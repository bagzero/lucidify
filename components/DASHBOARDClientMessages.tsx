...
const DASHBOARDClientMessages = () => {
    ...
    const [messages, setMessages] = useState([]); // Messages in the currently selected conversation
    const [selectedChat, setSelectedChat] = useState('Lucidify'); // Initially set to 'Lucidify'
                                                ...
                                                <div className="inline-flex gap-[15px]">
                                                    ...
                                                    <div className="rounded-[5px] BlackGradient ContentCardShadow inline-flex justify-center items-center self-start">
                                                        <div className="w-[35px] h-[35px] mx-[8px] my-[8px] flex items-center rounded-full overflow-clip">
                                                            <Image
                                                                src={auth.currentUser?.photoURL || "/Lucidify Umbrella.png"} // Fallback if no photoURL
                                                                alt="Your PFP"
                                                                layout="responsive"
                                                                width={0}
                                                                height={0}
